    ...
    <section id="contact">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    <form name="sentMessage" id="contactForm" onsubmit="return validateForm();" action="database-write.php" method="post">
                        <div class="row control-group">
                            <div class="form-group col-xs-12 floating-label-form-group controls">
                                <label>Name</label>
                                <input type="text" name="name" class="form-control" placeholder="Name" id="name" required data-validation-required-message="Enter your name please.">
